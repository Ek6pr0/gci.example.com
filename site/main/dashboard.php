  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <p class="d-inline-flex gap-1">
        <a class="btn text-white" data-bs-toggle="collapse" href="#collapseCoding" role="button" aria-expanded="false" aria-controls="collapseCoding">
          <svg class="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlink:href="#table"/></svg>
          Coding
        </a>
      </p>
        <div class="collapse" id="collapseCoding">
          <div class="card card-body mb-2 ms-0" style="background-color:rgb(37, 41, 41); border: solid, white">
            <button class="card-title">code1</button>
            <h7 class="card-title">code2</h7>
          </div>
        </div>
      </li>
      <li>
        <a href="about.php" class="nav-link text-white position-relative">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
        ...
        <li><a class="dropdown-item" href="../modules/checklogout.php">Sign out</a></li>
      </ul>
    </div>
  </div>
